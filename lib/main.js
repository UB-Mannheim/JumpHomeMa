...
//var name = "browser.startup.homepage";
//var startup_homepage = require("sdk/preferences/service").get(name);
//console.log("vor startup_homepage ---------------------------");
//console.log(startup_homepage);
//console.log("nach startup_homepage ---------------------------");
//console.log( "nach START 1 20.01.2015, 04:35:10 " );
...
pageMod.PageMod({
    ...
    onAttach: function(worker) {
        ...
        worker.port.emit("InfoStartseite", startup_homepage );
